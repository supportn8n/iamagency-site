...
<img src="/blk/kontakty/wm_i.webp" style="position:absolute;left:6px;top:67.88px;width:15.01px;height:93.02px;filter:drop-shadow(0 2.13px 2.13px rgba(0,0,0,.25))" alt="" />
<img src="/blk/kontakty/wm_am.webp" style="position:absolute;left:53.54px;top:67.88px;width:187.81px;height:93.02px;filter:drop-shadow(0 2.13px 2.13px rgba(0,0,0,.25))" alt="" />
<img src="/blk/kontakty/wm_agency.webp" style="position:absolute;left:277.88px;top:62px;width:484.09px;height:99.32px;filter:drop-shadow(0 2.13px 2.13px rgba(0,0,0,.25))" alt="I AM AGENCY" />
...
${social(40, "/hero/icons/1_telegram.webp")}
${social(69.41, "/hero/icons/3_instagram.webp")}
${social(98.97, "/hero/icons/4_whatsapp.webp", 24.86)}
${social(128.14, "/hero/icons/2_max.webp", 24.86)}
