...
export const CASES: CaseDir[] = [
  ...
  },
  {
    ...
    html: sportHtml,
    height: sportH,
    metaTitle: "Кейсы sport & education — SMM для спорта и обучения | I AM AGENCY",
    metaDescription:
      "Кейсы I AM AGENCY в нишах спорта и образования: продвижение фитнес-клубов, тренеров, школ и онлайн-курсов в соцсетях.",
  },
  {
    slug: "experts",
    name: "EXPERTS",
