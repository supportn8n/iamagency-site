/* Страница «Кейсы» — модуль «Кейсы / HoReCa» 1:1 из Figma IAM-WEB,
   фрейм HoReCa #12354:3925 (1440×1813, фон #FFFFFF).
   Тексты дословно из макета. Фото пока заглушки #E5E3E0
   (Figma API в лимите) — координаты/размеры точные, см. horeca.images.json.
...
<div style="position:relative;width:1440px;height:1813px;background:#FFFFFF;overflow:hidden;">
  ...
  <div style="position:absolute;left:68px;top:262px;width:462.29px;height:580.82px;border-radius:14.82px;">
    ...
    <div style="position:absolute;left:2.96px;top:179.28px;width:20px;font-family:Inter,sans-serif;font-weight:400;font-size:19.26px;line-height:104%;color:#1F1F1F;white-space:pre-line;margin:0;">✅
✅
✅
✅ 
✅</div>
    <div style="position:absolute;left:34.82px;top:177.06px;width:427.47px;font-family:Inter,sans-serif;font-weight:400;font-size:19.26px;line-height:104%;color:#1F1F1F;white-space:pre-line;margin:0;">написали <span style="font-weight:600">SMM-стратегию</span>
упаковали <span style="font-weight:600">профиль</span>
разработали <span style="font-weight:600">ТЗ для съемки</span>
для продвижения подключили <span style="font-weight:600">бот массовых действий</span>
создали <span style="font-weight:600">телеграм канал</span> для повышения коммуникации с пользователями в альтернативных социальных сетях</div>
    <div style="position:absolute;left:2.96px;top:0px;width:159.28px;font-family:Inter,sans-serif;font-weight:600;font-size:15.85px;line-height:104%;text-transform:uppercase;color:#1F1F1F;opacity:0.4;white-space:pre-line;margin:0;">Задача клиента:</div>
    <div style="position:absolute;left:2.96px;top:150.39px;width:159.28px;font-family:Inter,sans-serif;font-weight:600;font-size:15.85px;line-height:104%;text-transform:uppercase;color:#1F1F1F;opacity:0.4;white-space:pre-line;margin:0;">Что сделали:</div>
    <div style="position:absolute;left:0px;top:434.13px;width:443.76px;height:146.69px;border-radius:14.82px;">
      <div style="position:absolute;left:24.45px;top:48.15px;width:410.43px;font-family:Inter,sans-serif;font-weight:400;font-size:19.26px;line-height:104%;color:#1F1F1F;white-space:pre-line;margin:0;"><span style="font-weight:600">+20 000</span> новых лояльных подписчиков
<span style="font-weight:600">full-book</span> номеров на несколько месяцев 
<span style="font-weight:600">+300%</span> прирост подписчиков в тг-канале</div>
      <div style="position:absolute;left:24.45px;top:18.59px;width:159.28px;font-family:Inter,sans-serif;font-weight:600;font-size:15.85px;line-height:104%;text-transform:uppercase;color:#1F1F1F;opacity:0.4;white-space:pre-line;margin:0;">результат:</div>
      <div style="position:absolute;left:0px;top:0px;width:443.76px;height:146.69px;border-radius:14.82px;border:1.48px solid #000000;box-sizing:border-box;"></div>
    </div>
  </div>
  <div style="position:absolute;left:617px;top:228px;width:748px;height:614.69px;">
    <div style="position:absolute;left:0px;top:0px;width:158.77px;height:130.97px;">
    ...
    <div style="position:absolute;left:922.06px;top:0px;width:383.94px;height:721.02px;">
      ...
      <div style="position:absolute;left:113.37px;top:0px;width:156.45px;height:160.23px;">
        ...
        <div style="position:absolute;left:0px;top:127.73px;width:156.45px;height:32.5px;display:flex;align-items:center;justify-content:center;background:#FFFFFF;border:0.82px solid #272727;box-sizing:border-box;border-radius:24.75px;">
          <div style="font-family:Inter,sans-serif;font-weight:500;font-size:16.5px;line-height:86%;letter-spacing:-0.03em;text-align:right;color:#272727;white-space:pre-line;margin:0;">_themaplemsk_</div>
        </div>
      </div>
    </div>
    <div style="position:absolute;left:0px;top:0px;width:383.94px;height:721.02px;">
      <div style="position:absolute;left:0px;top:178.37px;width:383.94px;height:542.66px;border-radius:15.12px;background:#FFFFFF;border:1.51px solid #000000;box-sizing:border-box;"></div>
      <div style="position:absolute;left:116.39px;top:0px;width:156.45px;height:160.23px;">
        <div style="position:absolute;left:9.83px;top:0px;width:137.55px;height:137.55px;">
          <div style="position:absolute;left:-4.29px;top:-4.29px;width:146.33px;height:146.33px;border-radius:50%;background:linear-gradient(180deg, rgba(255, 0, 197, 1) 0%, rgba(255, 0, 0, 1) 32%, rgba(255, 134, 0, 1) 67%, rgba(255, 202, 0, 1) 100%);"></div>
          <div style="position:absolute;left:0.1px;top:0.1px;width:137.55px;height:137.55px;">
